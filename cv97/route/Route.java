...
public class Route extends LinkedListNode implements Constants {
	...
	public void update() {
		...
		if (eventInNode.isScriptNode()) {
			try {
				ScriptNode script = (ScriptNode)eventInNode;
		...
		GeometryNode geo = null;		
		if (eventInNode.isGeometryNode() == true)
			geo = (GeometryNode)eventInNode;
		else if (eventInParentNode.isGeometryNode() == true)
			geo = (GeometryNode)eventInParentNode;
/*
			...
			if (eventInParentNode != null) {
				...
				if (eventInParentParentNode != null) {
					if (eventInParentParentNode.isGeometryNode() == true) {
						geo = (GeometryNode)eventInParentParentNode;
					}
				}
			} 
		}
