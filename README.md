...
// Add a Shape node as a root node ShapeNode shape = new ShapeNode();
sg.addNode(shape);
...
DEF BOX Shape { geometry Box { size 10 20 30
...
VRML browser with Java3D easily. To use the feature, you have to create
